...
Proof.
  intros P Q R.
  intros H0.
  destruct H0 as [H0P H0Q].
  intros H1.
  destruct H1 as [H1Q H1R].
  split.
  - intros PP. apply H0P in PP. apply H1Q in PP. apply PP.
  - intros PR. apply H1R in PR. apply H0Q in PR. apply PR.
Qed.
(** [] *)
...
Proof.
  intros P Q R.
  split.
  - intros H0. destruct H0 as [H01 | H02].
               + split.
                 * left. apply H01.
                 * left. apply H01.
               + destruct H02 as [H02Q H02P]. split.
                                              * right. apply H02Q.
                                              * right. apply H02P.
  - intros H1. destruct H1 as [H12 H13]. destruct H12 as [H12P | H12Q].
                                         + left. apply H12P.
                                         + destruct H13 as [H13P | H13R].
                                           * left. apply H13P.
                                           * right. split. apply H12Q. apply H13R.
Qed.
...
Proof.
  ...
  split.
  - intros H1.
    destruct H1 as [x1 H2]. destruct H2 as [H3 | H4].
                            + left. exists x1. apply H3.
                            + right. exists x1. apply H4.
  - intros H5. 
    destruct H5 as [H6 | H7].
    + destruct H6 as [x2 H8]. exists x2. left. apply H8.
    + destruct H7 as [x3 H9]. exists x3. right. apply H9.
Qed.
...
Proof.
  ...
  - intros H. induction l as [|n l' IHl'].
              ...
              + destruct H.
                * exists n. split. apply H. simpl. left. reflexivity.
                * destruct IHl'. apply H. exists x. destruct H0. simpl. split. apply H0. right. apply H1.
  - intros H. inversion H. inversion H0. rewrite <- H1. apply In_map. apply H2.
Qed.
...
Proof.
  intros A l. induction l as [|n l1 IHl1].
  - simpl. split. + intros H0. right. apply H0.
                  + intros H0. inversion H0. inversion H.
           apply H.
  - simpl. split. + intros H0. inversion H0. * left. left. apply H.
                                             * apply or_assoc. right. apply IHl1. apply H.
                  + intros H0. inversion H0. * inversion H. left. apply H1. right. apply IHl1. apply or_assoc in H0. inversion H0. left. apply H1. apply H2.
                                             * apply or_assoc in H0. inversion H0. left. apply H1. right. apply IHl1. apply H1.
Qed.
(** [] *)
...
Proof.
  ...
  - intros H. induction l as [|n l' IHl'].
              ...
              + simpl. split.
                       ...
                       * apply IHl'. intros x. intros H1. apply H. simpl. right. apply H1.
  - intros H. intros x H1. induction l as [|n l' IHl'].
                           + inversion H1.
                           + destruct H1 as [H2 | H3]. * inversion H as [H4 H5]. rewrite <- H2. apply H4.
                                                       * apply IHl'. {inversion H as [H4 H5]. apply H5. }
                                                                     {apply H3. }
Qed.
(** [] *)
...
Definition combine_odd_even_helper (Podd Peven : nat -> Prop) (n : nat) : Prop :=
  if oddb n then Podd n
            else Peven n.

Definition combine_odd_even (Podd Peven : nat -> Prop) : nat -> Prop :=
    combine_odd_even_helper Podd Peven.
...
Proof.
  ...
  unfold combine_odd_even_helper.
  destruct (oddb n).
...
Lemma tr_rev_correct_lemma1 : forall (X:Type), forall (l1:list X) (l2:list X),
  rev_append l1 l2 = rev l1 ++ l2.
Proof.
  intros X l1.
  induction l1 as [|n' l1' IHl1'].
  - reflexivity.
  - intros l2. simpl. rewrite <- app_assoc. rewrite -> IHl1'. simpl. reflexivity.
Qed.
...
Proof.
  ...
  - reflexivity.
  - simpl. apply tr_rev_correct_lemma1.
Qed.
(** [] *)
...
Proof.
  ...
  - rewrite evenb_S.
    ...
    + simpl. inversion IHn'. exists (S x). rewrite -> H. reflexivity.
Qed.
(** [] *)

Check evenb_double_conv.
...
Proof.
  intros b1 b2.
  split.
  - intros H0. destruct b1.
               + destruct b2.
                 * split. reflexivity. reflexivity.
                 * simpl in H0. inversion H0.
               + destruct b2.
                 * split. simpl in H0. inversion H0. reflexivity.
                 * simpl in H0. inversion H0.
  - intros H0. inversion H0. rewrite -> H. rewrite -> H1. reflexivity.
Qed.
...
Proof.
  ...
  - intros H0. destruct b1.
               + left. reflexivity.
               + destruct b2. * right. reflexivity. * simpl in H0. inversion H0.
  - intros H0. inversion H0. + destruct b2. * rewrite -> H. reflexivity. * rewrite -> H. reflexivity.
                             + destruct b1. * rewrite -> H. reflexivity. * rewrite -> H. reflexivity.
Qed.
(** [] *)
...
Lemma beq_nat_false_iff_lemma1:
  ( true = false ) <-> False.
Proof.
  split.
  - intros H. inversion H.
...
Proof.
  intros x y.
  split.
  - intros H0. unfold not. intros H1. rewrite H1 in H0. Search beq_nat. rewrite beq_nat_trans_lemma1 in H0. inversion H0.
  - intros H0. unfold not in H0. apply not_true_iff_false. unfold not. intros H2. apply beq_nat_true_iff in H2. apply H0 in H2. apply H2.
Qed.
...
Fixpoint beq_list {A : Type} (beq : A -> A -> bool)
  ...
  | nil , _ => false
  | _ , nil => false
  | h1 :: t1 , h2 :: t2 => if beq h1 h2 then beq_list beq t1 t2
                                        else false
  end.

Lemma beq_list_true_iff_lemma1 :
  forall A (l1 l2 : list A) (a : A),
    a :: l1 = a :: l2 <-> l1 = l2.
Proof.
  intros A l1 l2 a.
  split.
  - intros H0. inversion H0. reflexivity.
  - intros H0. rewrite H0. reflexivity.
Qed.

Lemma beq_list_true_iff_lemma2 :
  forall A (l1 l2 : list A) (a b : A),
    a :: l1 = b :: l2 -> a = b.
Proof.
  intros A l1 l2 a b.
  intros H0. inversion H0. reflexivity.
...
Lemma beq_list_true_iff_lemma3 :
  forall A (l1 l2 : list A) (a b : A),
    a :: l1 = b :: l2 -> l1 = l2.
Proof.
  intros A l1 l2 a b.
...
Lemma beq_list_true_iff_lemma4 :
  forall A (l1 l2 : list A) (a b : A),
    a :: l1 = b :: l2 -> l1 = l2 /\ a = b.
Proof.
  split.
  - apply beq_list_true_iff_lemma3 in H. apply H.
  - apply beq_list_true_iff_lemma2 in H. apply H.
Qed.
...
Proof.
  ...
  intros l1.
  induction l1 as [|n l1' IHl1'].
  - split. + intros H1. destruct l2. reflexivity. inversion H1.
           + intros H1. rewrite <- H1. reflexivity.
  - split. + intros H1. destruct l2. * inversion H1. 
                                     * destruct (beq n a) eqn:Eq1. { apply H0 in Eq1. rewrite Eq1. apply beq_list_true_iff_lemma1. apply IHl1'. simpl in H1. apply H0 in Eq1. rewrite Eq1 in H1. apply H1. }
                                                                   { simpl in H1. rewrite Eq1 in H1. inversion H1. }
           + intros H1. destruct l2. * inversion H1.
                                     * apply beq_list_true_iff_lemma4 in H1. inversion H1. simpl. apply H0 in H2. rewrite H2. apply IHl1'. apply H.
Qed.
...
Proof.
  split.
  - intros H0. induction l as [|n' l' IHl'].
               + reflexivity.
               + simpl. split. * inversion H0. rewrite H1. Search "and". apply andb_true_iff in H1. inversion H1. apply H.
                               * inversion H0. rewrite H1. apply IHl'. apply andb_true_iff in H1. apply H1.
  - intros H0. induction l as [|n' l' IHl'].
               + reflexivity.
               + simpl. apply andb_true_iff. split. * inversion H0. apply H.
                                                    *  apply IHl'. inversion H0. apply H1.
Qed.
...
Proof.
  ...
  inversion H.
  - apply H2.
  - apply ex_falso_quodlibet. apply H1. exists x. intros H3. unfold not in H2. apply H2. apply H3.
Qed.
