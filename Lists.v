...
Theorem app_nil_r : forall l : natlist,
  l ++ [] = l.
Proof.
  intros l. induction l as [| n l' LHl'].
  - reflexivity.
...
Proof.
  intros l1 l2 l3 l4. induction l1 as [|n l1' LHl1'].
  - simpl. rewrite -> app_assoc. reflexivity.
  - simpl. rewrite -> LHl1'. reflexivity.
Qed.
...
Lemma beq_nat_n : forall n : nat,
  beq_nat n n = true.
Proof.
  intros n. induction n as [|n' IHl'].
  - reflexivity.
...
Proof.
  intros x. destruct x.
  simpl. rewrite -> beq_nat_n. reflexivity.
Qed.
(** [] *)
