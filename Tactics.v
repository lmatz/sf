...
Proof.
  intros l l'.
  intros H0.
  rewrite -> H0. symmetry. apply rev_involutive.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m H. apply beq_nat_0_l in H. symmetry. apply H.
...
Proof.
  ...
  - intros. simpl in H. destruct n.
                        + inversion H.
                        + inversion H. apply IHl' in H1. rewrite <- H1. simpl. inversion H. rewrite H2. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct (f false) eqn:Eq3.
    + destruct (f true) eqn:Eq4.
      * rewrite Eq4. reflexivity.
      * rewrite Eq3. reflexivity.
    + rewrite Eq3. rewrite Eq3. reflexivity.
Qed.
(** [] *)
...
Lemma beq_nat_trans_lemma1 : forall m,
  beq_nat m m = true.
Proof.
  intros m.
  induction m.
