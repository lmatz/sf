...
Proof.
  ...
  - intros H0. simpl. apply ev_SS. apply IHE'. apply H0.
Qed.
(** [] *)
...
Lemma double_plus_double : forall n m, double n + double m = double (n+m).
Proof.
  intros n.
  induction n as [|n' IHn'].
  - reflexivity.
  - simpl. intros m. apply eq_S. apply eq_S. apply IHn'.
Qed.

Lemma ev'_even : forall n,
  ev' n -> exists k, n = double k.
Proof.
  intros n E.
  induction E.
  ...
  - inversion IHE1. inversion IHE2. rewrite H. rewrite H0. exists (x+x0). apply double_plus_double.
Qed.
...
Theorem S_1 : forall n, S n = n + (S O).
Proof.
  intros n.
  induction n.
  - reflexivity.
  - rewrite -> IHn. Search "S". rewrite <- plus_Sn_m. rewrite IHn. reflexivity.
Qed.
...
Proof.
  ...
  split.
  - induction n as [| n' IHn'].
    + intros H0. apply ev_0.
    + intros H0. induction H0. * apply ev_0. * apply ev_SS. apply ev_0. * apply ev_even_iff in IHev'1. apply ev_even_iff in IHev'2. inversion IHev'1. inversion IHev'2. apply ev_even_iff. exists (x+x0). rewrite H. rewrite H0. apply double_plus_double.
  - induction n as [| n' IHn'].
    + intros H0. apply ev'_0.
    + intros H0. induction H0. * apply ev'_0. * rewrite S_1. rewrite S_1. Search "plus". rewrite <- plus_assoc. simpl. apply ev'_sum. apply IHev. apply ev'_2.
Qed.
(** [] *)
